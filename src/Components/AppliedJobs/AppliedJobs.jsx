...
let [sort, setSort] = useState(jobApplications);
let sortingg =(e) =>{
  let sortingData = jobApplications.filter((exist) => {
    return exist.remote_or_onsite == e;
        ...
        <div className="relative inline-block cursor-pointer">
          ...
          >
            <div
              ...
              role="none"
            >
              <button className="btn2 block border" onClick={() => sortingg("Onsite")}>
                Onsite
              </button>
              <button className="btn2 border" onClick={() => sortingg("Remote")}>
                Remote
              </button>
              {/* <button
